...
pub async fn purge_elasticsearch_indexes(
...
) -> Result<models::StatusOk, Error<PurgeElasticsearchIndexesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PurgeElasticsearchIndexesError> =
...
pub async fn test_elasticsearch(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<TestElasticsearchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TestElasticsearchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
