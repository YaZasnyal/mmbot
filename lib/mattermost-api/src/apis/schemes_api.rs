...
pub async fn create_scheme(configuration: &configuration::Configuration, create_scheme_request: models::CreateSchemeRequest) -> Result<models::Scheme, Error<CreateSchemeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/schemes", local_var_configuration.base_path);
...
pub async fn delete_scheme(configuration: &configuration::Configuration, scheme_id: &str) -> Result<models::StatusOk, Error<DeleteSchemeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/schemes/{scheme_id}", local_var_configuration.base_path, scheme_id=crate::apis::urlencode(scheme_id));
...
pub async fn get_channels_for_scheme(configuration: &configuration::Configuration, scheme_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::Channel>, Error<GetChannelsForSchemeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/schemes/{scheme_id}/channels", local_var_configuration.base_path, scheme_id=crate::apis::urlencode(scheme_id));
...
pub async fn get_scheme(configuration: &configuration::Configuration, scheme_id: &str) -> Result<models::Scheme, Error<GetSchemeError>> {
    let local_var_configuration = configuration;
...
pub async fn get_schemes(configuration: &configuration::Configuration, scope: Option<&str>, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::Scheme>, Error<GetSchemesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_teams_for_scheme(configuration: &configuration::Configuration, scheme_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::Team>, Error<GetTeamsForSchemeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/schemes/{scheme_id}/teams", local_var_configuration.base_path, scheme_id=crate::apis::urlencode(scheme_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn patch_scheme(configuration: &configuration::Configuration, scheme_id: &str, patch_scheme_request: models::PatchSchemeRequest) -> Result<models::Scheme, Error<PatchSchemeError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/schemes/{scheme_id}/patch", local_var_configuration.base_path, scheme_id=crate::apis::urlencode(scheme_id));
