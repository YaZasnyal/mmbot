...
pub async fn open_interactive_dialog(
    ...
    open_interactive_dialog_request: models::OpenInteractiveDialogRequest,
) -> Result<models::StatusOk, Error<OpenInteractiveDialogError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<OpenInteractiveDialogError> =
...
pub async fn submit_interactive_dialog(
    configuration: &configuration::Configuration,
    submit_interactive_dialog_request: models::SubmitInteractiveDialogRequest,
) -> Result<models::StatusOk, Error<SubmitInteractiveDialogError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SubmitInteractiveDialogError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
