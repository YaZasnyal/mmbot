...
pub async fn delete_preferences(
    ...
    user_id: &str,
    preference: Vec<models::Preference>,
) -> Result<models::StatusOk, Error<DeletePreferencesError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePreferencesError> =
...
pub async fn get_preferences(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::Preference>, Error<GetPreferencesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPreferencesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_preferences_by_category(
    ...
    user_id: &str,
    category: &str,
) -> Result<Vec<models::Preference>, Error<GetPreferencesByCategoryError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPreferencesByCategoryError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_preferences_by_category_by_name(
    configuration: &configuration::Configuration,
    user_id: &str,
    category: &str,
    preference_name: &str,
) -> Result<models::Preference, Error<GetPreferencesByCategoryByNameError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        user_id = crate::apis::urlencode(user_id),
        category = crate::apis::urlencode(category),
        preference_name = crate::apis::urlencode(preference_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPreferencesByCategoryByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_preferences(
    ...
    user_id: &str,
    preference: Vec<models::Preference>,
) -> Result<models::StatusOk, Error<UpdatePreferencesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePreferencesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
