...
pub async fn check_integrity(configuration: &configuration::Configuration, ) -> Result<Vec<models::IntegrityCheckResult>, Error<CheckIntegrityError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/integrity", local_var_configuration.base_path);
...
pub async fn clear_server_busy(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<ClearServerBusyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/server_busy", local_var_configuration.base_path);
...
pub async fn database_recycle(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<DatabaseRecycleError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/database/recycle", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn generate_support_packet(configuration: &configuration::Configuration, basic_server_logs: Option<bool>, plugin_packets: Option<&str>) -> Result<(), Error<GenerateSupportPacketError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/system/support_packet", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());

    if let Some(ref local_var_str) = basic_server_logs {
        local_var_req_builder = local_var_req_builder.query(&[("basic_server_logs", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = plugin_packets {
        local_var_req_builder = local_var_req_builder.query(&[("plugin_packets", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn get_analytics_old(configuration: &configuration::Configuration, name: Option<&str>, team_id: Option<&str>) -> Result<(), Error<GetAnalyticsOldError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/analytics/old", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_audits(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::Audit>, Error<GetAuditsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/audits", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_client_config(configuration: &configuration::Configuration, format: &str) -> Result<(), Error<GetClientConfigError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/config/client", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_client_license(configuration: &configuration::Configuration, format: &str) -> Result<(), Error<GetClientLicenseError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/license/client", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_config(configuration: &configuration::Configuration, ) -> Result<models::Config, Error<GetConfigError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/config", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_environment_config(configuration: &configuration::Configuration, ) -> Result<models::EnvironmentConfig, Error<GetEnvironmentConfigError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/config/environment", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_image_by_url(configuration: &configuration::Configuration, ) -> Result<std::path::PathBuf, Error<GetImageByUrlError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/image", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_logs(configuration: &configuration::Configuration, page: Option<i32>, logs_per_page: Option<&str>) -> Result<Vec<String>, Error<GetLogsError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/logs", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_notices(configuration: &configuration::Configuration, client_version: &str, client: &str, team_id: &str, locale: Option<&str>) -> Result<Vec<models::Notice>, Error<GetNoticesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/system/notices/{teamId}", local_var_configuration.base_path, teamId=crate::apis::urlencode(team_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_ping(configuration: &configuration::Configuration, get_server_status: Option<bool>, device_id: Option<&str>, use_rest_semantics: Option<bool>) -> Result<models::SystemStatusResponse, Error<GetPingError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/system/ping", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = use_rest_semantics {
        local_var_req_builder = local_var_req_builder.query(&[("use_rest_semantics", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    }
...
pub async fn get_prev_trial_license(configuration: &configuration::Configuration, ) -> Result<(), Error<GetPrevTrialLicenseError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/trial-license/prev", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_redirect_location(configuration: &configuration::Configuration, url: &str) -> Result<models::GetRedirectLocation200Response, Error<GetRedirectLocationError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/redirect_location", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_server_busy_expires(configuration: &configuration::Configuration, ) -> Result<models::ServerBusy, Error<GetServerBusyExpiresError>> {
    let local_var_configuration = configuration;
...
pub async fn get_supported_timezone(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<GetSupportedTimezoneError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/system/timezones", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn invalidate_caches(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<InvalidateCachesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/caches/invalidate", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn mark_notices_viewed(configuration: &configuration::Configuration, request_body: Vec<String>) -> Result<models::StatusOk, Error<MarkNoticesViewedError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/system/notices/view", local_var_configuration.base_path);
...
pub async fn patch_config(configuration: &configuration::Configuration, config: models::Config) -> Result<models::Config, Error<PatchConfigError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/config/patch", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
pub async fn post_log(configuration: &configuration::Configuration, post_log_request: models::PostLogRequest) -> Result<Vec<String>, Error<PostLogError>> {
    let local_var_configuration = configuration;
...
pub async fn reload_config(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<ReloadConfigError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/config/reload", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn remove_license_file(configuration: &configuration::Configuration, ) -> Result<(), Error<RemoveLicenseFileError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/license", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn request_license_renewal_link(configuration: &configuration::Configuration, ) -> Result<models::LicenseRenewalLink, Error<RequestLicenseRenewalLinkError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/license/renewal", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn request_trial_license(configuration: &configuration::Configuration, request_trial_license_request: models::RequestTrialLicenseRequest) -> Result<(), Error<RequestTrialLicenseError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/trial-license", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn restart_server(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<RestartServerError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/restart", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn set_server_busy(configuration: &configuration::Configuration, seconds: Option<&str>) -> Result<models::StatusOk, Error<SetServerBusyError>> {
    let local_var_configuration = configuration;
...
pub async fn test_email(configuration: &configuration::Configuration, config: models::Config) -> Result<models::StatusOk, Error<TestEmailError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/email/test", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn test_s3_connection(configuration: &configuration::Configuration, config: models::Config) -> Result<models::StatusOk, Error<TestS3ConnectionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/file/s3_test", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn test_site_url(configuration: &configuration::Configuration, test_site_url_request: models::TestSiteUrlRequest) -> Result<models::StatusOk, Error<TestSiteUrlError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/site_url/test", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_config(configuration: &configuration::Configuration, config: models::Config) -> Result<models::Config, Error<UpdateConfigError>> {
    let local_var_configuration = configuration;
...
pub async fn update_marketplace_visited_by_admin(configuration: &configuration::Configuration, system: models::System) -> Result<models::StatusOk, Error<UpdateMarketplaceVisitedByAdminError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/plugins/marketplace/first_admin_visit", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn upgrade_to_enterprise(configuration: &configuration::Configuration, ) -> Result<models::PushNotification, Error<UpgradeToEnterpriseError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/upgrade_to_enterprise", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn upgrade_to_enterprise_status(configuration: &configuration::Configuration, ) -> Result<models::UpgradeToEnterpriseStatus200Response, Error<UpgradeToEnterpriseStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/upgrade_to_enterprise/status", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn upload_license_file(configuration: &configuration::Configuration, license: std::path::PathBuf) -> Result<models::StatusOk, Error<UploadLicenseFileError>> {
    let local_var_configuration = configuration;
