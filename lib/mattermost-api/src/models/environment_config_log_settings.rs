...
pub struct EnvironmentConfigLogSettings {
    ...
    #[serde(rename = "ConsoleLevel", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "FileLevel", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub file_level: Option<bool>,
    #[serde(rename = "FileLocation", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
