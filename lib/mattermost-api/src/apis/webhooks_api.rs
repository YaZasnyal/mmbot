...
pub async fn create_incoming_webhook(configuration: &configuration::Configuration, create_incoming_webhook_request: models::CreateIncomingWebhookRequest) -> Result<models::IncomingWebhook, Error<CreateIncomingWebhookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/hooks/incoming", local_var_configuration.base_path);
...
pub async fn create_outgoing_webhook(configuration: &configuration::Configuration, create_outgoing_webhook_request: models::CreateOutgoingWebhookRequest) -> Result<models::OutgoingWebhook, Error<CreateOutgoingWebhookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/hooks/outgoing", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_incoming_webhook(configuration: &configuration::Configuration, hook_id: &str) -> Result<models::StatusOk, Error<DeleteIncomingWebhookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/hooks/incoming/{hook_id}", local_var_configuration.base_path, hook_id=crate::apis::urlencode(hook_id));
...
pub async fn delete_outgoing_webhook(configuration: &configuration::Configuration, hook_id: &str) -> Result<models::StatusOk, Error<DeleteOutgoingWebhookError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/hooks/outgoing/{hook_id}", local_var_configuration.base_path, hook_id=crate::apis::urlencode(hook_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_incoming_webhook(configuration: &configuration::Configuration, hook_id: &str) -> Result<models::IncomingWebhook, Error<GetIncomingWebhookError>> {
    let local_var_configuration = configuration;
...
pub async fn get_incoming_webhooks(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, team_id: Option<&str>, include_total_count: Option<bool>) -> Result<Vec<models::IncomingWebhook>, Error<GetIncomingWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn get_outgoing_webhook(configuration: &configuration::Configuration, hook_id: &str) -> Result<models::OutgoingWebhook, Error<GetOutgoingWebhookError>> {
    let local_var_configuration = configuration;
...
pub async fn get_outgoing_webhooks(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, team_id: Option<&str>, channel_id: Option<&str>) -> Result<Vec<models::OutgoingWebhook>, Error<GetOutgoingWebhooksError>> {
    let local_var_configuration = configuration;
...
pub async fn regen_outgoing_hook_token(configuration: &configuration::Configuration, hook_id: &str) -> Result<models::StatusOk, Error<RegenOutgoingHookTokenError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/hooks/outgoing/{hook_id}/regen_token", local_var_configuration.base_path, hook_id=crate::apis::urlencode(hook_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_incoming_webhook(configuration: &configuration::Configuration, hook_id: &str, update_incoming_webhook_request: models::UpdateIncomingWebhookRequest) -> Result<models::IncomingWebhook, Error<UpdateIncomingWebhookError>> {
    let local_var_configuration = configuration;
...
pub async fn update_outgoing_webhook(configuration: &configuration::Configuration, hook_id: &str, update_outgoing_webhook_request: models::UpdateOutgoingWebhookRequest) -> Result<models::OutgoingWebhook, Error<UpdateOutgoingWebhookError>> {
    let local_var_configuration = configuration;
