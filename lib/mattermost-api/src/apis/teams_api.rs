...
pub async fn add_team_member(
    ...
    team_id: &str,
    add_team_member_request: models::AddTeamMemberRequest,
) -> Result<models::TeamMember, Error<AddTeamMemberError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTeamMemberError> =
...
pub async fn add_team_member_from_invite(
    configuration: &configuration::Configuration,
    token: &str,
) -> Result<models::TeamMember, Error<AddTeamMemberFromInviteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTeamMemberFromInviteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn add_team_members(
    configuration: &configuration::Configuration,
    team_id: &str,
    team_member: Vec<models::TeamMember>,
    graceful: Option<bool>,
) -> Result<Vec<models::TeamMember>, Error<AddTeamMembersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = graceful {
        local_var_req_builder =
            local_var_req_builder.query(&[("graceful", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTeamMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_team(
    configuration: &configuration::Configuration,
    create_team_request: models::CreateTeamRequest,
) -> Result<models::Team, Error<CreateTeamError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_teams(
...
) -> Result<Vec<models::Team>, Error<GetAllTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_by_name(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<models::Team, Error<GetTeamByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_icon(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamIconError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_invite_info(
    configuration: &configuration::Configuration,
    invite_id: &str,
) -> Result<models::GetTeamInviteInfo200Response, Error<GetTeamInviteInfoError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        invite_id = crate::apis::urlencode(invite_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamInviteInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_member(
    ...
    team_id: &str,
    user_id: &str,
) -> Result<models::TeamMember, Error<GetTeamMemberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamMemberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_members(
    ...
    if let Some(ref local_var_str) = exclude_deleted_users {
        local_var_req_builder =
            local_var_req_builder.query(&[("exclude_deleted_users", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_members_by_ids(
...
) -> Result<Vec<models::TeamMember>, Error<GetTeamMembersByIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamMembersByIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_members_for_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::TeamMember>, Error<GetTeamMembersForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamMembersForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_stats(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<models::TeamStats, Error<GetTeamStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_unread(
    ...
    user_id: &str,
    team_id: &str,
) -> Result<models::TeamUnread, Error<GetTeamUnreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamUnreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_teams_for_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::Team>, Error<GetTeamsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_teams_unread_for_user(
...
) -> Result<Vec<models::TeamUnread>, Error<GetTeamsUnreadForUserError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.query(&[("exclude_team", &exclude_team.to_string())]);
    if let Some(ref local_var_str) = include_collapsed_threads {
        local_var_req_builder = local_var_req_builder
            .query(&[("include_collapsed_threads", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamsUnreadForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn import_team(
    ...
    filesize: i32,
    import_from: &str,
) -> Result<models::ImportTeam200Response, Error<ImportTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ImportTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn invalidate_email_invites(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<InvalidateEmailInvitesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<InvalidateEmailInvitesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn invite_guests_to_team(
    configuration: &configuration::Configuration,
    team_id: &str,
    invite_guests_to_team_request: models::InviteGuestsToTeamRequest,
) -> Result<models::StatusOk, Error<InviteGuestsToTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<InviteGuestsToTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn invite_users_to_team(
    ...
    team_id: &str,
    request_body: Vec<String>,
) -> Result<models::StatusOk, Error<InviteUsersToTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<InviteUsersToTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_team(
    configuration: &configuration::Configuration,
    team_id: &str,
    patch_team_request: models::PatchTeamRequest,
) -> Result<models::Team, Error<PatchTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn regenerate_team_invite_id(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<models::Team, Error<RegenerateTeamInviteIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegenerateTeamInviteIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_team_icon(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<models::StatusOk, Error<RemoveTeamIconError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveTeamIconError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_team_member(
    ...
    team_id: &str,
    user_id: &str,
) -> Result<models::StatusOk, Error<RemoveTeamMemberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveTeamMemberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restore_team(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<models::Team, Error<RestoreTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestoreTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_files(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::FileInfoList, Error<SearchFilesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchFilesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_teams(
    configuration: &configuration::Configuration,
    search_teams_request: models::SearchTeamsRequest,
) -> Result<models::SearchTeams200Response, Error<SearchTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_team_icon(
...
) -> Result<models::StatusOk, Error<SetTeamIconError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetTeamIconError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn soft_delete_team(
...
) -> Result<models::StatusOk, Error<SoftDeleteTeamError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = permanent {
        local_var_req_builder =
            local_var_req_builder.query(&[("permanent", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SoftDeleteTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn team_exists(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<models::TeamExists, Error<TeamExistsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamExistsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn team_members_minus_group_members(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<(), Error<TeamMembersMinusGroupMembersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<TeamMembersMinusGroupMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_team(
    configuration: &configuration::Configuration,
    team_id: &str,
    update_team_request: models::UpdateTeamRequest,
) -> Result<models::Team, Error<UpdateTeamError>> {
    let local_var_configuration = configuration;
...
pub async fn update_team_member_roles(
...
) -> Result<models::StatusOk, Error<UpdateTeamMemberRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTeamMemberRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_team_member_scheme_roles(
...
) -> Result<models::StatusOk, Error<UpdateTeamMemberSchemeRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTeamMemberSchemeRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_team_privacy(
    configuration: &configuration::Configuration,
    team_id: &str,
    update_team_privacy_request: models::UpdateTeamPrivacyRequest,
) -> Result<models::Team, Error<UpdateTeamPrivacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTeamPrivacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_team_scheme(
...
) -> Result<models::StatusOk, Error<UpdateTeamSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateTeamSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
