...
pub async fn create_compliance_report(
...
) -> Result<models::Compliance, Error<CreateComplianceReportError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateComplianceReportError> =
...
pub async fn download_compliance_report(
    configuration: &configuration::Configuration,
    report_id: &str,
) -> Result<(), Error<DownloadComplianceReportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadComplianceReportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_compliance_report(
    configuration: &configuration::Configuration,
    report_id: &str,
) -> Result<models::Compliance, Error<GetComplianceReportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetComplianceReportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_compliance_reports(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Compliance>, Error<GetComplianceReportsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetComplianceReportsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
