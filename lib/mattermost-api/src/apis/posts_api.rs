...
pub async fn create_post(
...
) -> Result<models::Post, Error<CreatePostError>> {
    ...
    if let Some(ref local_var_str) = set_online {
        local_var_req_builder =
            local_var_req_builder.query(&[("set_online", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePostError> =
...
pub async fn create_post_ephemeral(
    configuration: &configuration::Configuration,
    create_post_ephemeral_request: models::CreatePostEphemeralRequest,
) -> Result<models::Post, Error<CreatePostEphemeralError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePostEphemeralError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_acknowledgement_for_post(
    ...
    user_id: &str,
    post_id: &str,
) -> Result<models::StatusOk, Error<DeleteAcknowledgementForPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteAcknowledgementForPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_post(
    configuration: &configuration::Configuration,
    post_id: &str,
) -> Result<models::StatusOk, Error<DeletePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeletePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn do_post_action(
    ...
    post_id: &str,
    action_id: &str,
) -> Result<models::StatusOk, Error<DoPostActionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DoPostActionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_file_infos_for_post(
...
) -> Result<Vec<models::FileInfo>, Error<GetFileInfosForPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFileInfosForPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_flagged_posts_for_user(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::PostList>, Error<GetFlaggedPostsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFlaggedPostsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_post(
    ...
    post_id: &str,
    include_deleted: Option<bool>,
) -> Result<models::Post, Error<GetPostError>> {
    let local_var_configuration = configuration;
...
pub async fn get_post_thread(
    ...
    from_create_at: Option<i32>,
    direction: Option<&str>,
    skip_fetch_threads: Option<bool>,
    collapsed_threads: Option<bool>,
    collapsed_threads_extended: Option<bool>,
) -> Result<models::PostList, Error<GetPostThreadError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = per_page {
        local_var_req_builder =
            local_var_req_builder.query(&[("perPage", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = from_post {
        local_var_req_builder =
            local_var_req_builder.query(&[("fromPost", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = from_create_at {
        local_var_req_builder =
            local_var_req_builder.query(&[("fromCreateAt", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = skip_fetch_threads {
        local_var_req_builder =
            local_var_req_builder.query(&[("skipFetchThreads", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = collapsed_threads {
        local_var_req_builder =
            local_var_req_builder.query(&[("collapsedThreads", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = collapsed_threads_extended {
        local_var_req_builder = local_var_req_builder
            .query(&[("collapsedThreadsExtended", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPostThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_posts_around_last_unread(
    ...
    collapsed_threads: Option<bool>,
    collapsed_threads_extended: Option<bool>,
) -> Result<models::PostList, Error<GetPostsAroundLastUnreadError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = limit_before {
        local_var_req_builder =
            local_var_req_builder.query(&[("limit_before", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = limit_after {
        local_var_req_builder =
            local_var_req_builder.query(&[("limit_after", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = skip_fetch_threads {
        local_var_req_builder =
            local_var_req_builder.query(&[("skipFetchThreads", &local_var_str.to_string())]);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPostsAroundLastUnreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_posts_by_ids(
...
) -> Result<Vec<models::Post>, Error<GetPostsByIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPostsByIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_posts_for_channel(
    ...
    after: Option<&str>,
    include_deleted: Option<bool>,
) -> Result<models::PostList, Error<GetPostsForChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPostsForChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn move_thread(
    configuration: &configuration::Configuration,
    post_id: &str,
    move_thread_request: models::MoveThreadRequest,
) -> Result<models::StatusOk, Error<MoveThreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MoveThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_post(
    configuration: &configuration::Configuration,
    post_id: &str,
    patch_post_request: models::PatchPostRequest,
) -> Result<models::Post, Error<PatchPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn pin_post(
    configuration: &configuration::Configuration,
    post_id: &str,
) -> Result<models::StatusOk, Error<PinPostError>> {
    let local_var_configuration = configuration;
...
pub async fn save_acknowledgement_for_post(
    ...
    user_id: &str,
    post_id: &str,
) -> Result<models::PostAcknowledgement, Error<SaveAcknowledgementForPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SaveAcknowledgementForPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_posts(
    configuration: &configuration::Configuration,
    team_id: &str,
    search_posts_request: models::SearchPostsRequest,
) -> Result<models::PostListWithSearchMatches, Error<SearchPostsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchPostsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_post_reminder(
    ...
    user_id: &str,
    post_id: &str,
    set_post_reminder_request: models::SetPostReminderRequest,
) -> Result<models::StatusOk, Error<SetPostReminderError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetPostReminderError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_post_unread(
    ...
    user_id: &str,
    post_id: &str,
) -> Result<models::ChannelUnreadAt, Error<SetPostUnreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetPostUnreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unpin_post(
    configuration: &configuration::Configuration,
    post_id: &str,
) -> Result<models::StatusOk, Error<UnpinPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnpinPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_post(
...
) -> Result<models::Post, Error<UpdatePostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
