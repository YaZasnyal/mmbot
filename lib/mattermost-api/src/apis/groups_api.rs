...
pub async fn add_group_members(
    ...
    group_id: &str,
    add_group_members_request: models::AddGroupMembersRequest,
) -> Result<models::StatusOk, Error<AddGroupMembersError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddGroupMembersError> =
...
pub async fn delete_group(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<models::StatusOk, Error<DeleteGroupError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_group_members(
    configuration: &configuration::Configuration,
    group_id: &str,
    delete_group_members_request: models::DeleteGroupMembersRequest,
) -> Result<models::StatusOk, Error<DeleteGroupMembersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteGroupMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_stats(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<models::GetGroupStats200Response, Error<GetGroupStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_syncable_for_channel_id(
    configuration: &configuration::Configuration,
    group_id: &str,
    channel_id: &str,
) -> Result<models::GroupSyncableChannel, Error<GetGroupSyncableForChannelIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupSyncableForChannelIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_syncable_for_team_id(
    configuration: &configuration::Configuration,
    group_id: &str,
    team_id: &str,
) -> Result<models::GroupSyncableTeam, Error<GetGroupSyncableForTeamIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupSyncableForTeamIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_syncables_channels(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<Vec<models::GroupSyncableChannels>, Error<GetGroupSyncablesChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupSyncablesChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_syncables_teams(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<Vec<models::GroupSyncableTeams>, Error<GetGroupSyncablesTeamsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupSyncablesTeamsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_group_users(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::GetGroupUsers200Response, Error<GetGroupUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups(
...
) -> Result<Vec<models::Group>, Error<GetGroupsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = include_member_count {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_member_count", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = filter_allow_reference {
        local_var_req_builder =
            local_var_req_builder.query(&[("filter_allow_reference", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn get_groups_associated_to_channels_by_team(
    ...
    Vec<std::collections::HashMap<String, Vec<models::GroupWithSchemeAdmin>>>,
...
> {
    ...
    if let Some(ref local_var_str) = paginate {
        local_var_req_builder =
            local_var_req_builder.query(&[("paginate", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsAssociatedToChannelsByTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups_by_channel(
    ...
    per_page: Option<i32>,
    filter_allow_reference: Option<bool>,
) -> Result<Vec<models::Group>, Error<GetGroupsByChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsByChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups_by_team(
    ...
    per_page: Option<i32>,
    filter_allow_reference: Option<bool>,
) -> Result<Vec<models::Group>, Error<GetGroupsByTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsByTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_groups_by_user_id(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::Group>, Error<GetGroupsByUserIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetGroupsByUserIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn link_group_syncable_for_channel(
    configuration: &configuration::Configuration,
    group_id: &str,
    channel_id: &str,
) -> Result<models::GroupSyncableChannel, Error<LinkGroupSyncableForChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LinkGroupSyncableForChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn link_group_syncable_for_team(
    configuration: &configuration::Configuration,
    group_id: &str,
    team_id: &str,
) -> Result<models::GroupSyncableTeam, Error<LinkGroupSyncableForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LinkGroupSyncableForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_group(
    configuration: &configuration::Configuration,
    group_id: &str,
    patch_group_request: models::PatchGroupRequest,
) -> Result<models::Group, Error<PatchGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_group_syncable_for_channel(
    configuration: &configuration::Configuration,
    group_id: &str,
    channel_id: &str,
    patch_group_syncable_for_team_request: models::PatchGroupSyncableForTeamRequest,
) -> Result<models::GroupSyncableChannel, Error<PatchGroupSyncableForChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchGroupSyncableForChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
/// Partially update a GroupSyncable by providing only the fields you want to update. Omitted fields will not be updated. The fields that can be updated are defined in the request body, all other provided fields will be ignored.  ##### Permissions Must have `manage_system` permission.  __Minimum server version__: 5.11
pub async fn patch_group_syncable_for_team(
    configuration: &configuration::Configuration,
    group_id: &str,
    team_id: &str,
    patch_group_syncable_for_team_request: models::PatchGroupSyncableForTeamRequest,
) -> Result<models::GroupSyncableTeam, Error<PatchGroupSyncableForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchGroupSyncableForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restore_group(
    configuration: &configuration::Configuration,
    group_id: &str,
) -> Result<models::StatusOk, Error<RestoreGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestoreGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unlink_group_syncable_for_channel(
    configuration: &configuration::Configuration,
    group_id: &str,
    channel_id: &str,
) -> Result<models::StatusOk, Error<UnlinkGroupSyncableForChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkGroupSyncableForChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unlink_group_syncable_for_team(
    configuration: &configuration::Configuration,
    group_id: &str,
    team_id: &str,
) -> Result<models::StatusOk, Error<UnlinkGroupSyncableForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkGroupSyncableForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unlink_ldap_group(
    configuration: &configuration::Configuration,
    remote_id: &str,
) -> Result<models::StatusOk, Error<UnlinkLdapGroupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnlinkLdapGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
