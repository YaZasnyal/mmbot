...
------------- | ------------- | -------------
[**purge_elasticsearch_indexes**](ElasticsearchApi.md#purge_elasticsearch_indexes) | **POST** /api/v4/elasticsearch/purge_indexes | Purge all Elasticsearch indexes
[**test_elasticsearch**](ElasticsearchApi.md#test_elasticsearch) | **POST** /api/v4/elasticsearch/test | Test Elasticsearch configuration



## purge_elasticsearch_indexes

> models::StatusOk purge_elasticsearch_indexes()
...
> models::StatusOk test_elasticsearch()
