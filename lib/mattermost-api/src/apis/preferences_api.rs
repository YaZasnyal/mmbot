...
pub async fn delete_preferences(configuration: &configuration::Configuration, user_id: &str, preference: Vec<models::Preference>) -> Result<models::StatusOk, Error<DeletePreferencesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/preferences/delete", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn get_preferences(configuration: &configuration::Configuration, user_id: &str) -> Result<Vec<models::Preference>, Error<GetPreferencesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/preferences", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn get_preferences_by_category(configuration: &configuration::Configuration, user_id: &str, category: &str) -> Result<Vec<models::Preference>, Error<GetPreferencesByCategoryError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/preferences/{category}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id), category=crate::apis::urlencode(category));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_preferences_by_category_by_name(configuration: &configuration::Configuration, user_id: &str, category: &str, preference_name: &str) -> Result<models::Preference, Error<GetPreferencesByCategoryByNameError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/preferences/{category}/name/{preference_name}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id), category=crate::apis::urlencode(category), preference_name=crate::apis::urlencode(preference_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn update_preferences(configuration: &configuration::Configuration, user_id: &str, preference: Vec<models::Preference>) -> Result<models::StatusOk, Error<UpdatePreferencesError>> {
    let local_var_configuration = configuration;
