...
pub async fn get_thread_mention_counts_by_channel(
    ...
    user_id: &str,
    team_id: &str,
) -> Result<(), Error<GetThreadMentionCountsByChannelError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetThreadMentionCountsByChannelError> =
...
pub async fn get_user_thread(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_threads(
...
) -> Result<models::UserThreads, Error<GetUserThreadsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = extended {
        local_var_req_builder =
            local_var_req_builder.query(&[("extended", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = totals_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("totalsOnly", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = threads_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("threadsOnly", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserThreadsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_thread_unread_by_post_id(
    configuration: &configuration::Configuration,
    user_id: &str,
    team_id: &str,
    thread_id: &str,
    post_id: &str,
) -> Result<(), Error<SetThreadUnreadByPostIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetThreadUnreadByPostIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn start_following_thread(
    configuration: &configuration::Configuration,
    user_id: &str,
    team_id: &str,
    thread_id: &str,
) -> Result<(), Error<StartFollowingThreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StartFollowingThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn stop_following_thread(
    configuration: &configuration::Configuration,
    user_id: &str,
    team_id: &str,
    thread_id: &str,
) -> Result<(), Error<StopFollowingThreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<StopFollowingThreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_thread_read_for_user(
    ...
    thread_id: &str,
    timestamp: &str,
) -> Result<(), Error<UpdateThreadReadForUserError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        team_id = crate::apis::urlencode(team_id),
        thread_id = crate::apis::urlencode(thread_id),
        timestamp = crate::apis::urlencode(timestamp)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateThreadReadForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_threads_read_for_user(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateThreadsReadForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
