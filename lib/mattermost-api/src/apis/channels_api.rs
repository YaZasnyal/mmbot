...
pub async fn add_channel_member(
    ...
    channel_id: &str,
    add_channel_member_request: models::AddChannelMemberRequest,
) -> Result<models::ChannelMember, Error<AddChannelMemberError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddChannelMemberError> =
...
pub async fn autocomplete_channels_for_team(
    ...
    team_id: &str,
    name: &str,
) -> Result<Vec<models::Channel>, Error<AutocompleteChannelsForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AutocompleteChannelsForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn autocomplete_channels_for_team_for_search(
    ...
    team_id: &str,
    name: &str,
) -> Result<Vec<models::Channel>, Error<AutocompleteChannelsForTeamForSearchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AutocompleteChannelsForTeamForSearchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn channel_members_minus_group_members(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<(), Error<ChannelMembersMinusGroupMembersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChannelMembersMinusGroupMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_channel(
    configuration: &configuration::Configuration,
    create_channel_request: models::CreateChannelRequest,
...
pub async fn create_direct_channel(
...
) -> Result<models::Channel, Error<CreateDirectChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDirectChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_group_channel(
    configuration: &configuration::Configuration,
    request_body: Vec<String>,
) -> Result<models::Channel, Error<CreateGroupChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateGroupChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_sidebar_category_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    sidebar_category: models::SidebarCategory,
) -> Result<models::SidebarCategory, Error<CreateSidebarCategoryForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSidebarCategoryForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_channel(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<models::StatusOk, Error<DeleteChannelError>> {
    let local_var_configuration = configuration;
...
pub async fn get_all_channels(
...
) -> Result<Vec<models::ChannelWithTeamData>, Error<GetAllChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = not_associated_to_group {
        local_var_req_builder =
            local_var_req_builder.query(&[("not_associated_to_group", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = page {
        local_var_req_builder =
            local_var_req_builder.query(&[("page", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = exclude_default_channels {
        local_var_req_builder = local_var_req_builder
            .query(&[("exclude_default_channels", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = exclude_policy_constrained {
        local_var_req_builder = local_var_req_builder
            .query(&[("exclude_policy_constrained", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAllChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_by_name(
    ...
    channel_name: &str,
    include_deleted: Option<bool>,
) -> Result<models::Channel, Error<GetChannelByNameError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        team_id = crate::apis::urlencode(team_id),
        channel_name = crate::apis::urlencode(channel_name)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_by_name_for_team_name(
    ...
    channel_name: &str,
    include_deleted: Option<bool>,
) -> Result<models::Channel, Error<GetChannelByNameForTeamNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelByNameForTeamNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_member(
    ...
    channel_id: &str,
    user_id: &str,
) -> Result<models::ChannelMember, Error<GetChannelMemberError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMemberError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_member_counts_by_group(
    configuration: &configuration::Configuration,
    channel_id: &str,
    include_timezones: Option<bool>,
) -> Result<(), Error<GetChannelMemberCountsByGroupError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = include_timezones {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_timezones", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMemberCountsByGroupError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_members(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::ChannelMember>, Error<GetChannelMembersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMembersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_members_by_ids(
    ...
    channel_id: &str,
    request_body: Vec<String>,
) -> Result<Vec<models::ChannelMember>, Error<GetChannelMembersByIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMembersByIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_members_for_user(
    ...
    user_id: &str,
    team_id: &str,
) -> Result<Vec<models::ChannelMember>, Error<GetChannelMembersForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMembersForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_members_timezones(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<Vec<String>, Error<GetChannelMembersTimezonesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMembersTimezonesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_moderations(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<Vec<models::ChannelModeration>, Error<GetChannelModerationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelModerationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_unread(
    ...
    user_id: &str,
    channel_id: &str,
) -> Result<models::ChannelUnread, Error<GetChannelUnreadError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelUnreadError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels_for_team_for_user(
    ...
    team_id: &str,
    include_deleted: Option<bool>,
    last_delete_at: Option<i32>,
) -> Result<Vec<models::Channel>, Error<GetChannelsForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = last_delete_at {
        local_var_req_builder =
            local_var_req_builder.query(&[("last_delete_at", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelsForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels_for_user(
    ...
    last_delete_at: Option<i32>,
    include_deleted: Option<bool>,
) -> Result<Vec<models::Channel>, Error<GetChannelsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_deleted_channels_for_team(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Channel>, Error<GetDeletedChannelsForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDeletedChannelsForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_pinned_posts(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<models::PostList, Error<GetPinnedPostsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPinnedPostsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_private_channels_for_team(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Channel>, Error<GetPrivateChannelsForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPrivateChannelsForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_public_channels_by_ids_for_team(
    ...
    team_id: &str,
    request_body: Vec<String>,
) -> Result<Vec<models::Channel>, Error<GetPublicChannelsByIdsForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPublicChannelsByIdsForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_public_channels_for_team(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Channel>, Error<GetPublicChannelsForTeamError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPublicChannelsForTeamError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sidebar_categories_for_team_for_user(
    ...
    team_id: &str,
    user_id: &str,
) -> Result<Vec<models::OrderedSidebarCategories>, Error<GetSidebarCategoriesForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSidebarCategoriesForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sidebar_category_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    category_id: &str,
) -> Result<models::SidebarCategory, Error<GetSidebarCategoryForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSidebarCategoryForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sidebar_category_order_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
) -> Result<Vec<String>, Error<GetSidebarCategoryOrderForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSidebarCategoryOrderForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn move_channel(
    configuration: &configuration::Configuration,
    channel_id: &str,
    move_channel_request: models::MoveChannelRequest,
) -> Result<models::Channel, Error<MoveChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MoveChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_channel(
    configuration: &configuration::Configuration,
    channel_id: &str,
    patch_channel_request: models::PatchChannelRequest,
) -> Result<models::Channel, Error<PatchChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_channel_moderations(
    configuration: &configuration::Configuration,
    channel_id: &str,
    channel_moderation_patch: models::ChannelModerationPatch,
) -> Result<Vec<models::ChannelModeration>, Error<PatchChannelModerationsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchChannelModerationsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_sidebar_category_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    category_id: &str,
) -> Result<models::SidebarCategory, Error<RemoveSidebarCategoryForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveSidebarCategoryForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_user_from_channel(
    ...
    channel_id: &str,
    user_id: &str,
) -> Result<models::StatusOk, Error<RemoveUserFromChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveUserFromChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restore_channel(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<models::Channel, Error<RestoreChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestoreChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_all_channels(
    configuration: &configuration::Configuration,
    search_all_channels_request: models::SearchAllChannelsRequest,
    system_console: Option<bool>,
) -> Result<models::SearchAllChannels200Response, Error<SearchAllChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = system_console {
        local_var_req_builder =
            local_var_req_builder.query(&[("system_console", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchAllChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_archived_channels(
    configuration: &configuration::Configuration,
    team_id: &str,
    search_archived_channels_request: models::SearchArchivedChannelsRequest,
) -> Result<Vec<models::Channel>, Error<SearchArchivedChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchArchivedChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_channels(
    configuration: &configuration::Configuration,
    team_id: &str,
    search_channels_request: models::SearchChannelsRequest,
) -> Result<Vec<models::Channel>, Error<SearchChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_group_channels(
    configuration: &configuration::Configuration,
    search_group_channels_request: models::SearchGroupChannelsRequest,
) -> Result<Vec<models::Channel>, Error<SearchGroupChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchGroupChannelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_channel(
    configuration: &configuration::Configuration,
    channel_id: &str,
    update_channel_request: models::UpdateChannelRequest,
) -> Result<models::Channel, Error<UpdateChannelError>> {
    let local_var_configuration = configuration;
...
pub async fn update_channel_member_scheme_roles(
    ...
    channel_id: &str,
    user_id: &str,
    update_team_member_scheme_roles_request: models::UpdateTeamMemberSchemeRolesRequest,
) -> Result<models::StatusOk, Error<UpdateChannelMemberSchemeRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChannelMemberSchemeRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_channel_notify_props(
    ...
    channel_id: &str,
    user_id: &str,
    channel_notify_props: models::ChannelNotifyProps,
) -> Result<models::StatusOk, Error<UpdateChannelNotifyPropsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChannelNotifyPropsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_channel_privacy(
    configuration: &configuration::Configuration,
    channel_id: &str,
    update_channel_privacy_request: models::UpdateChannelPrivacyRequest,
) -> Result<models::Channel, Error<UpdateChannelPrivacyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChannelPrivacyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_channel_roles(
...
) -> Result<models::StatusOk, Error<UpdateChannelRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChannelRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_channel_scheme(
    configuration: &configuration::Configuration,
    channel_id: &str,
    update_team_scheme_request: models::UpdateTeamSchemeRequest,
) -> Result<models::StatusOk, Error<UpdateChannelSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateChannelSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_sidebar_categories_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    sidebar_category: Vec<models::SidebarCategory>,
) -> Result<models::SidebarCategory, Error<UpdateSidebarCategoriesForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSidebarCategoriesForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_sidebar_category_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    category_id: &str,
    sidebar_category: models::SidebarCategory,
) -> Result<models::SidebarCategory, Error<UpdateSidebarCategoryForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSidebarCategoryForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_sidebar_category_order_for_team_for_user(
    configuration: &configuration::Configuration,
    team_id: &str,
    user_id: &str,
    request_body: Vec<String>,
) -> Result<Vec<String>, Error<UpdateSidebarCategoryOrderForTeamForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateSidebarCategoryOrderForTeamForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn view_channel(
    configuration: &configuration::Configuration,
    user_id: &str,
    view_channel_request: models::ViewChannelRequest,
) -> Result<models::ViewChannel200Response, Error<ViewChannelError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ViewChannelError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
