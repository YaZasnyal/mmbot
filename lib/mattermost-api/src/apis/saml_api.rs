...
pub async fn delete_saml_idp_certificate(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<DeleteSamlIdpCertificateError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSamlIdpCertificateError> =
...
pub async fn delete_saml_private_certificate(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<DeleteSamlPrivateCertificateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSamlPrivateCertificateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_saml_public_certificate(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<DeleteSamlPublicCertificateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSamlPublicCertificateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_saml_certificate_status(
    configuration: &configuration::Configuration,
) -> Result<models::SamlCertificateStatus, Error<GetSamlCertificateStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSamlCertificateStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_saml_metadata(
    configuration: &configuration::Configuration,
) -> Result<String, Error<GetSamlMetadataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSamlMetadataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_saml_metadata_from_idp(
    configuration: &configuration::Configuration,
    get_saml_metadata_from_idp_request: Option<models::GetSamlMetadataFromIdpRequest>,
) -> Result<String, Error<GetSamlMetadataFromIdpError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSamlMetadataFromIdpError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrate_auth_to_saml_2(
    configuration: &configuration::Configuration,
    migrate_auth_to_saml_request: Option<models::MigrateAuthToSamlRequest>,
) -> Result<(), Error<MigrateAuthToSaml2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToSaml2Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reset_saml_auth_data_to_email(
    configuration: &configuration::Configuration,
    reset_saml_auth_data_to_email_request: Option<models::ResetSamlAuthDataToEmailRequest>,
) -> Result<models::ResetSamlAuthDataToEmail200Response, Error<ResetSamlAuthDataToEmailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResetSamlAuthDataToEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_saml_idp_certificate(
    configuration: &configuration::Configuration,
    certificate: std::path::PathBuf,
) -> Result<models::StatusOk, Error<UploadSamlIdpCertificateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadSamlIdpCertificateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_saml_private_certificate(
    configuration: &configuration::Configuration,
    certificate: std::path::PathBuf,
) -> Result<models::StatusOk, Error<UploadSamlPrivateCertificateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadSamlPrivateCertificateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_saml_public_certificate(
    configuration: &configuration::Configuration,
    certificate: std::path::PathBuf,
) -> Result<models::StatusOk, Error<UploadSamlPublicCertificateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UploadSamlPublicCertificateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
