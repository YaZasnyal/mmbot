...
pub async fn attach_device_extra_props(
    configuration: &configuration::Configuration,
    attach_device_extra_props_request: models::AttachDeviceExtraPropsRequest,
) -> Result<models::StatusOk, Error<AttachDeviceExtraPropsError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AttachDeviceExtraPropsError> =
...
pub async fn autocomplete_users(
    ...
    limit: Option<i32>,
) -> Result<models::UserAutocomplete, Error<AutocompleteUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AutocompleteUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn check_user_mfa(
    configuration: &configuration::Configuration,
    check_user_mfa_request: models::CheckUserMfaRequest,
) -> Result<models::CheckUserMfa200Response, Error<CheckUserMfaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CheckUserMfaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn convert_bot_to_user_0(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
    convert_bot_to_user_request: models::ConvertBotToUserRequest,
    set_system_admin: Option<bool>,
) -> Result<models::StatusOk, Error<ConvertBotToUser0Error>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        bot_user_id = crate::apis::urlencode(bot_user_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if let Some(ref local_var_str) = set_system_admin {
        local_var_req_builder =
            local_var_req_builder.query(&[("set_system_admin", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConvertBotToUser0Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn convert_user_to_bot_0(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<ConvertUserToBot0Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConvertUserToBot0Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_user_access_token(
    configuration: &configuration::Configuration,
    user_id: &str,
    create_user_access_token_request: models::CreateUserAccessTokenRequest,
) -> Result<models::UserAccessToken, Error<CreateUserAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateUserAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<DeleteUserError>> {
    let local_var_configuration = configuration;
...
pub async fn demote_user_to_guest(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<DemoteUserToGuestError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DemoteUserToGuestError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn disable_user_access_token(
    configuration: &configuration::Configuration,
    disable_user_access_token_request: models::DisableUserAccessTokenRequest,
) -> Result<models::StatusOk, Error<DisableUserAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DisableUserAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn enable_user_access_token(
    configuration: &configuration::Configuration,
    enable_user_access_token_request: models::EnableUserAccessTokenRequest,
) -> Result<models::StatusOk, Error<EnableUserAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EnableUserAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn generate_mfa_secret(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::GenerateMfaSecret200Response, Error<GenerateMfaSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GenerateMfaSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_members_with_team_data_for_user(
    configuration: &configuration::Configuration,
    user_id: &str,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::ChannelMemberWithTeamData>, Error<GetChannelMembersWithTeamDataForUserError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelMembersWithTeamDataForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_default_profile_image(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<(), Error<GetDefaultProfileImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDefaultProfileImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_known_users(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<GetKnownUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetKnownUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_server_limits(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::ServerLimits>, Error<GetServerLimitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetServerLimitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_sessions(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::Session>, Error<GetSessionsError>> {
    let local_var_configuration = configuration;
...
pub async fn get_total_users_stats(
    configuration: &configuration::Configuration,
) -> Result<models::UsersStats, Error<GetTotalUsersStatsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTotalUsersStatsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_total_users_stats_filtered(
    configuration: &configuration::Configuration,
    in_team: Option<&str>,
    ...
    roles: Option<&str>,
    channel_roles: Option<&str>,
    team_roles: Option<&str>,
) -> Result<models::UsersStats, Error<GetTotalUsersStatsFilteredError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = in_team {
        local_var_req_builder =
            local_var_req_builder.query(&[("in_team", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = in_channel {
        local_var_req_builder =
            local_var_req_builder.query(&[("in_channel", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = include_bots {
        local_var_req_builder =
            local_var_req_builder.query(&[("include_bots", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = roles {
        local_var_req_builder =
            local_var_req_builder.query(&[("roles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = channel_roles {
        local_var_req_builder =
            local_var_req_builder.query(&[("channel_roles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = team_roles {
        local_var_req_builder =
            local_var_req_builder.query(&[("team_roles", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTotalUsersStatsFilteredError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_uploads_for_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::UploadSession>, Error<GetUploadsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUploadsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_access_token(
    configuration: &configuration::Configuration,
    token_id: &str,
) -> Result<models::UserAccessTokenSanitized, Error<GetUserAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        token_id = crate::apis::urlencode(token_id)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_access_tokens(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::UserAccessTokenSanitized>, Error<GetUserAccessTokensError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserAccessTokensError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_access_tokens_for_user(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::UserAccessTokenSanitized>, Error<GetUserAccessTokensForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserAccessTokensForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_audits(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<Vec<models::Audit>, Error<GetUserAuditsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserAuditsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_by_email(
    configuration: &configuration::Configuration,
    email: &str,
) -> Result<models::User, Error<GetUserByEmailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserByEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_by_username(
    configuration: &configuration::Configuration,
    username: &str,
) -> Result<models::User, Error<GetUserByUsernameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserByUsernameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_count_for_reporting(
    ...
    has_no_team: Option<bool>,
    hide_active: Option<bool>,
    hide_inactive: Option<bool>,
    search_term: Option<&str>,
) -> Result<f64, Error<GetUserCountForReportingError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = role_filter {
        local_var_req_builder =
            local_var_req_builder.query(&[("role_filter", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = team_filter {
        local_var_req_builder =
            local_var_req_builder.query(&[("team_filter", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = has_no_team {
        local_var_req_builder =
            local_var_req_builder.query(&[("has_no_team", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = hide_active {
        local_var_req_builder =
            local_var_req_builder.query(&[("hide_active", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = hide_inactive {
        local_var_req_builder =
            local_var_req_builder.query(&[("hide_inactive", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = search_term {
        local_var_req_builder =
            local_var_req_builder.query(&[("search_term", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserCountForReportingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_user_terms_of_service(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::UserTermsOfService, Error<GetUserTermsOfServiceError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserTermsOfServiceError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users(
    ...
    per_page: Option<i32>,
    in_team: Option<&str>,
    not_in_team: Option<&str>,
    in_channel: Option<&str>,
    not_in_channel: Option<&str>,
    in_group: Option<&str>,
    ...
    if let Some(ref local_var_str) = not_in_team {
        local_var_req_builder =
            local_var_req_builder.query(&[("not_in_team", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = in_channel {
        local_var_req_builder =
            local_var_req_builder.query(&[("in_channel", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = not_in_channel {
        local_var_req_builder =
            local_var_req_builder.query(&[("not_in_channel", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = in_group {
        local_var_req_builder =
            local_var_req_builder.query(&[("in_group", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = group_constrained {
        local_var_req_builder =
            local_var_req_builder.query(&[("group_constrained", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = without_team {
        local_var_req_builder =
            local_var_req_builder.query(&[("without_team", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = inactive {
        local_var_req_builder =
            local_var_req_builder.query(&[("inactive", &local_var_str.to_string())]);
    }
...
pub async fn get_users_by_group_channel_ids(
...
) -> Result<models::GetUsersByGroupChannelIds200Response, Error<GetUsersByGroupChannelIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersByGroupChannelIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users_by_ids(
    ...
    request_body: Vec<String>,
    since: Option<i32>,
) -> Result<Vec<models::User>, Error<GetUsersByIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersByIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users_by_usernames(
    configuration: &configuration::Configuration,
    request_body: Vec<String>,
) -> Result<Vec<models::User>, Error<GetUsersByUsernamesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersByUsernamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users_for_reporting(
    ...
    hide_inactive: Option<bool>,
    search_term: Option<&str>,
) -> Result<Vec<models::UserReport>, Error<GetUsersForReportingError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = sort_column {
        local_var_req_builder =
            local_var_req_builder.query(&[("sort_column", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = from_column_value {
        local_var_req_builder =
            local_var_req_builder.query(&[("from_column_value", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = from_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("from_id", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersForReportingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_users_with_invalid_emails(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::User>, Error<GetUsersWithInvalidEmailsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersWithInvalidEmailsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<models::User, Error<LoginError>> {
    let local_var_configuration = configuration;
...
pub async fn login_by_cws_token(
    configuration: &configuration::Configuration,
    login_by_cws_token_request: models::LoginByCwsTokenRequest,
) -> Result<(), Error<LoginByCwsTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LoginByCwsTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn logout(
    configuration: &configuration::Configuration,
) -> Result<models::StatusOk, Error<LogoutError>> {
    let local_var_configuration = configuration;
...
pub async fn migrate_auth_to_ldap(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToLdapError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn migrate_auth_to_saml(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToSamlError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_user(
    configuration: &configuration::Configuration,
    user_id: &str,
    patch_user_request: models::PatchUserRequest,
) -> Result<models::User, Error<PatchUserError>> {
    let local_var_configuration = configuration;
...
pub async fn permanent_delete_all_users(
    configuration: &configuration::Configuration,
) -> Result<(), Error<PermanentDeleteAllUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PermanentDeleteAllUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn promote_guest_to_user(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<PromoteGuestToUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PromoteGuestToUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn publish_user_typing(
    configuration: &configuration::Configuration,
    user_id: &str,
    publish_user_typing_request: Option<models::PublishUserTypingRequest>,
) -> Result<(), Error<PublishUserTypingError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PublishUserTypingError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn register_terms_of_service_action(
    configuration: &configuration::Configuration,
    user_id: &str,
    register_terms_of_service_action_request: models::RegisterTermsOfServiceActionRequest,
) -> Result<models::StatusOk, Error<RegisterTermsOfServiceActionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegisterTermsOfServiceActionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<models::StatusOk, Error<ResetPasswordError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_all_sessions(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<RevokeAllSessionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeAllSessionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn revoke_session(
    configuration: &configuration::Configuration,
    user_id: &str,
    revoke_session_request: models::RevokeSessionRequest,
) -> Result<models::StatusOk, Error<RevokeSessionError>> {
    let local_var_configuration = configuration;
...
pub async fn revoke_sessions_from_all_users(
    configuration: &configuration::Configuration,
) -> Result<(), Error<RevokeSessionsFromAllUsersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeSessionsFromAllUsersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn revoke_user_access_token(
    configuration: &configuration::Configuration,
    revoke_user_access_token_request: models::RevokeUserAccessTokenRequest,
) -> Result<models::StatusOk, Error<RevokeUserAccessTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RevokeUserAccessTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_user_access_tokens(
    configuration: &configuration::Configuration,
    search_user_access_tokens_request: models::SearchUserAccessTokensRequest,
) -> Result<Vec<models::UserAccessTokenSanitized>, Error<SearchUserAccessTokensError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchUserAccessTokensError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<Vec<models::User>, Error<SearchUsersError>> {
    let local_var_configuration = configuration;
...
pub async fn send_password_reset_email(
    configuration: &configuration::Configuration,
    send_password_reset_email_request: models::SendPasswordResetEmailRequest,
) -> Result<models::StatusOk, Error<SendPasswordResetEmailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SendPasswordResetEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn send_verification_email(
    configuration: &configuration::Configuration,
    send_verification_email_request: models::SendVerificationEmailRequest,
) -> Result<models::StatusOk, Error<SendVerificationEmailError>> {
    let local_var_configuration = configuration;
...
pub async fn set_default_profile_image(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<SetDefaultProfileImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetDefaultProfileImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn set_profile_image(
...
) -> Result<models::StatusOk, Error<SetProfileImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetProfileImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn switch_account_type(
    configuration: &configuration::Configuration,
    switch_account_type_request: models::SwitchAccountTypeRequest,
) -> Result<models::SwitchAccountType200Response, Error<SwitchAccountTypeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SwitchAccountTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_active(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_active_request: models::UpdateUserActiveRequest,
) -> Result<models::StatusOk, Error<UpdateUserActiveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserActiveError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_auth(
    configuration: &configuration::Configuration,
    user_id: &str,
    user_auth_data: models::UserAuthData,
) -> Result<models::UserAuthData, Error<UpdateUserAuthError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserAuthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_mfa(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_mfa_request: models::UpdateUserMfaRequest,
) -> Result<models::StatusOk, Error<UpdateUserMfaError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserMfaError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_password(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_password_request: models::UpdateUserPasswordRequest,
) -> Result<models::StatusOk, Error<UpdateUserPasswordError>> {
    let local_var_configuration = configuration;
...
pub async fn update_user_roles(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_roles_request: models::UpdateUserRolesRequest,
) -> Result<models::StatusOk, Error<UpdateUserRolesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserRolesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn verify_user_email(
...
) -> Result<models::StatusOk, Error<VerifyUserEmailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VerifyUserEmailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn verify_user_email_without_token(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::User, Error<VerifyUserEmailWithoutTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<VerifyUserEmailWithoutTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
