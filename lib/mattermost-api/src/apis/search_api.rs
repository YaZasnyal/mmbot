...
/// struct for typed errors of method [`search_files_1`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum SearchFiles1Error {
...
pub async fn search_files_1(configuration: &configuration::Configuration, team_id: &str, terms: &str, is_or_search: bool, time_zone_offset: Option<i32>, include_deleted_channels: Option<bool>, page: Option<i32>, per_page: Option<i32>) -> Result<models::FileInfoList, Error<SearchFiles1Error>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchFiles1Error> = serde_json::from_str(&local_var_content).ok();
