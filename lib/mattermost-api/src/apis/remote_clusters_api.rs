...
pub async fn accept_remote_cluster_invite(
    configuration: &configuration::Configuration,
    accept_remote_cluster_invite_request: Option<models::AcceptRemoteClusterInviteRequest>,
) -> Result<models::RemoteCluster, Error<AcceptRemoteClusterInviteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AcceptRemoteClusterInviteError> =
...
pub async fn create_remote_cluster(
    configuration: &configuration::Configuration,
    create_remote_cluster_request: Option<models::CreateRemoteClusterRequest>,
) -> Result<models::CreateRemoteCluster201Response, Error<CreateRemoteClusterError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateRemoteClusterError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_remote_cluster(
    configuration: &configuration::Configuration,
    remote_id: &str,
) -> Result<(), Error<DeleteRemoteClusterError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteRemoteClusterError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_remote_cluster(
    configuration: &configuration::Configuration,
    remote_id: &str,
) -> Result<models::RemoteCluster, Error<GetRemoteClusterError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRemoteClusterError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_remote_clusters(
    ...
    only_plugins: Option<bool>,
    exclude_plugins: Option<bool>,
    include_deleted: Option<bool>,
) -> Result<Vec<models::RemoteCluster>, Error<GetRemoteClustersError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = exclude_offline {
        local_var_req_builder =
            local_var_req_builder.query(&[("exclude_offline", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = only_confirmed {
        local_var_req_builder =
            local_var_req_builder.query(&[("only_confirmed", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = only_plugins {
        local_var_req_builder =
            local_var_req_builder.query(&[("only_plugins", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = exclude_plugins {
        local_var_req_builder =
            local_var_req_builder.query(&[("exclude_plugins", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetRemoteClustersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_remote_cluster(
    configuration: &configuration::Configuration,
    remote_id: &str,
    patch_remote_cluster_request: Option<models::PatchRemoteClusterRequest>,
) -> Result<models::RemoteCluster, Error<PatchRemoteClusterError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchRemoteClusterError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
