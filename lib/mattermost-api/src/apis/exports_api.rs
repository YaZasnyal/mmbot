...
pub async fn delete_export(
    ...
    export_name: &str,
) -> Result<(), Error<DeleteExportError>> {
    ...
    let local_var_uri_str = format!(
        ...
        export_name = crate::apis::urlencode(export_name)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteExportError> =
...
pub async fn download_export(
    configuration: &configuration::Configuration,
    export_name: &str,
) -> Result<(), Error<DownloadExportError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadExportError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_exports(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListExportsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
