...
pub async fn create_scheme(
    ...
    create_scheme_request: models::CreateSchemeRequest,
) -> Result<models::Scheme, Error<CreateSchemeError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateSchemeError> =
...
pub async fn delete_scheme(
    configuration: &configuration::Configuration,
    scheme_id: &str,
) -> Result<models::StatusOk, Error<DeleteSchemeError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        scheme_id = crate::apis::urlencode(scheme_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels_for_scheme(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Channel>, Error<GetChannelsForSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelsForSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_scheme(
    configuration: &configuration::Configuration,
    scheme_id: &str,
) -> Result<models::Scheme, Error<GetSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_schemes(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Scheme>, Error<GetSchemesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetSchemesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_teams_for_scheme(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Team>, Error<GetTeamsForSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamsForSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_scheme(
    configuration: &configuration::Configuration,
    scheme_id: &str,
    patch_scheme_request: models::PatchSchemeRequest,
) -> Result<models::Scheme, Error<PatchSchemeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchSchemeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
