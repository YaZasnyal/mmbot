...
pub async fn add_channels_to_retention_policy(configuration: &configuration::Configuration, policy_id: &str, request_body: Vec<String>) -> Result<models::StatusOk, Error<AddChannelsToRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies/{policy_id}/channels", local_var_configuration.base_path, policy_id=crate::apis::urlencode(policy_id));
...
pub async fn add_teams_to_retention_policy(configuration: &configuration::Configuration, policy_id: &str, request_body: Vec<String>) -> Result<models::StatusOk, Error<AddTeamsToRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies/{policy_id}/teams", local_var_configuration.base_path, policy_id=crate::apis::urlencode(policy_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn create_data_retention_policy(configuration: &configuration::Configuration, data_retention_policy_create: models::DataRetentionPolicyCreate) -> Result<models::DataRetentionPolicyWithTeamAndChannelCounts, Error<CreateDataRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn delete_data_retention_policy(configuration: &configuration::Configuration, policy_id: &str) -> Result<models::StatusOk, Error<DeleteDataRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies/{policy_id}", local_var_configuration.base_path, policy_id=crate::apis::urlencode(policy_id));
...
pub async fn get_channel_policies_for_user(configuration: &configuration::Configuration, user_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::RetentionPolicyForChannelList, Error<GetChannelPoliciesForUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/data_retention/channel_policies", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn get_channels_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::ChannelWithTeamData>, Error<GetChannelsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn get_data_retention_policies(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::DataRetentionPolicyWithTeamAndChannelCounts>, Error<GetDataRetentionPoliciesError>> {
    let local_var_configuration = configuration;
...
pub async fn get_data_retention_policies_count(configuration: &configuration::Configuration, ) -> Result<models::GetDataRetentionPoliciesCount200Response, Error<GetDataRetentionPoliciesCountError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies_count", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_data_retention_policy(configuration: &configuration::Configuration, ) -> Result<models::GlobalDataRetentionPolicy, Error<GetDataRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policy", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_data_retention_policy_by_id(configuration: &configuration::Configuration, policy_id: &str) -> Result<models::DataRetentionPolicyWithTeamAndChannelCounts, Error<GetDataRetentionPolicyByIdError>> {
    let local_var_configuration = configuration;
...
pub async fn get_team_policies_for_user(configuration: &configuration::Configuration, user_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<models::RetentionPolicyForTeamList, Error<GetTeamPoliciesForUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/data_retention/team_policies", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_teams_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::Team>, Error<GetTeamsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn patch_data_retention_policy(configuration: &configuration::Configuration, policy_id: &str, data_retention_policy_with_team_and_channel_ids: models::DataRetentionPolicyWithTeamAndChannelIds) -> Result<models::DataRetentionPolicyWithTeamAndChannelCounts, Error<PatchDataRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_channels_from_retention_policy(configuration: &configuration::Configuration, policy_id: &str, request_body: Vec<String>) -> Result<models::StatusOk, Error<RemoveChannelsFromRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn remove_teams_from_retention_policy(configuration: &configuration::Configuration, policy_id: &str, request_body: Vec<String>) -> Result<models::StatusOk, Error<RemoveTeamsFromRetentionPolicyError>> {
    let local_var_configuration = configuration;
...
pub async fn search_channels_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, search_channels_for_retention_policy_request: models::SearchChannelsForRetentionPolicyRequest) -> Result<Vec<models::ChannelWithTeamData>, Error<SearchChannelsForRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies/{policy_id}/channels/search", local_var_configuration.base_path, policy_id=crate::apis::urlencode(policy_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn search_teams_for_retention_policy(configuration: &configuration::Configuration, policy_id: &str, search_teams_for_retention_policy_request: models::SearchTeamsForRetentionPolicyRequest) -> Result<Vec<models::Team>, Error<SearchTeamsForRetentionPolicyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/data_retention/policies/{policy_id}/teams/search", local_var_configuration.base_path, policy_id=crate::apis::urlencode(policy_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
