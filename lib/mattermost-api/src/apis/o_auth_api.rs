...
pub async fn create_o_auth_app(
    ...
    create_o_auth_app_request: models::CreateOAuthAppRequest,
) -> Result<models::OAuthApp, Error<CreateOAuthAppError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateOAuthAppError> =
...
pub async fn delete_o_auth_app(
    configuration: &configuration::Configuration,
    app_id: &str,
) -> Result<models::StatusOk, Error<DeleteOAuthAppError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        app_id = crate::apis::urlencode(app_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteOAuthAppError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_authorized_o_auth_apps_for_user(
    configuration: &configuration::Configuration,
    user_id: &str,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::OAuthApp>, Error<GetAuthorizedOAuthAppsForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetAuthorizedOAuthAppsForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_o_auth_app(
    configuration: &configuration::Configuration,
    app_id: &str,
) -> Result<models::OAuthApp, Error<GetOAuthAppError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetOAuthAppError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_o_auth_app_info(
    configuration: &configuration::Configuration,
    app_id: &str,
) -> Result<models::OAuthApp, Error<GetOAuthAppInfoError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetOAuthAppInfoError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_o_auth_apps(
    configuration: &configuration::Configuration,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::OAuthApp>, Error<GetOAuthAppsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetOAuthAppsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn regenerate_o_auth_app_secret(
    configuration: &configuration::Configuration,
    app_id: &str,
) -> Result<models::OAuthApp, Error<RegenerateOAuthAppSecretError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegenerateOAuthAppSecretError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_o_auth_app(
    configuration: &configuration::Configuration,
    app_id: &str,
    update_o_auth_app_request: models::UpdateOAuthAppRequest,
) -> Result<models::OAuthApp, Error<UpdateOAuthAppError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateOAuthAppError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
