...
/// struct for typed errors of method [`get_emojis_by_names`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEmojisByNamesError {
    Status400(models::AppError),
    Status401(models::AppError),
    Status501(models::AppError),
    UnknownValue(serde_json::Value),
...
pub async fn autocomplete_emoji(configuration: &configuration::Configuration, name: &str) -> Result<models::Emoji, Error<AutocompleteEmojiError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji/autocomplete", local_var_configuration.base_path);
...
pub async fn create_emoji(configuration: &configuration::Configuration, image: std::path::PathBuf, emoji: &str) -> Result<models::Emoji, Error<CreateEmojiError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji", local_var_configuration.base_path);
...
pub async fn delete_emoji(configuration: &configuration::Configuration, emoji_id: &str) -> Result<models::Emoji, Error<DeleteEmojiError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji/{emoji_id}", local_var_configuration.base_path, emoji_id=crate::apis::urlencode(emoji_id));
...
pub async fn get_emoji(configuration: &configuration::Configuration, emoji_id: &str) -> Result<models::Emoji, Error<GetEmojiError>> {
    let local_var_configuration = configuration;
...
pub async fn get_emoji_by_name(configuration: &configuration::Configuration, emoji_name: &str) -> Result<models::Emoji, Error<GetEmojiByNameError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji/name/{emoji_name}", local_var_configuration.base_path, emoji_name=crate::apis::urlencode(emoji_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_emoji_image(configuration: &configuration::Configuration, emoji_id: &str) -> Result<(), Error<GetEmojiImageError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/emoji/{emoji_id}/image", local_var_configuration.base_path, emoji_id=crate::apis::urlencode(emoji_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_emoji_list(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>, sort: Option<&str>) -> Result<models::Emoji, Error<GetEmojiListError>> {
    let local_var_configuration = configuration;
...
pub async fn get_emojis_by_names(configuration: &configuration::Configuration, request_body: Vec<String>) -> Result<Vec<models::User>, Error<GetEmojisByNamesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji/names", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmojisByNamesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn search_emoji(configuration: &configuration::Configuration, search_emoji_request: models::SearchEmojiRequest) -> Result<Vec<models::Emoji>, Error<SearchEmojiError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/emoji/search", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
