...
pub async fn autocomplete_emoji(
    configuration: &configuration::Configuration,
    name: &str,
) -> Result<models::Emoji, Error<AutocompleteEmojiError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AutocompleteEmojiError> =
...
pub async fn create_emoji(
    ...
    emoji: &str,
) -> Result<models::Emoji, Error<CreateEmojiError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateEmojiError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_emoji(
    configuration: &configuration::Configuration,
    emoji_id: &str,
) -> Result<models::Emoji, Error<DeleteEmojiError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        emoji_id = crate::apis::urlencode(emoji_id)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteEmojiError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_emoji(
    configuration: &configuration::Configuration,
    emoji_id: &str,
) -> Result<models::Emoji, Error<GetEmojiError>> {
    let local_var_configuration = configuration;
...
pub async fn get_emoji_by_name(
    configuration: &configuration::Configuration,
    emoji_name: &str,
) -> Result<models::Emoji, Error<GetEmojiByNameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmojiByNameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_emoji_image(
    configuration: &configuration::Configuration,
    emoji_id: &str,
) -> Result<(), Error<GetEmojiImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmojiImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_emoji_list(
    ...
    per_page: Option<i32>,
    sort: Option<&str>,
) -> Result<models::Emoji, Error<GetEmojiListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmojiListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_emojis_by_names(
...
) -> Result<Vec<models::User>, Error<GetEmojisByNamesError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEmojisByNamesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_emoji(
    configuration: &configuration::Configuration,
    search_emoji_request: models::SearchEmojiRequest,
) -> Result<Vec<models::Emoji>, Error<SearchEmojiError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchEmojiError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
