...
pub async fn add_checklist_item(
    ...
    id: &str,
    checklist: i32,
    add_checklist_item_request: Option<models::AddChecklistItemRequest>,
) -> Result<(), Error<AddChecklistItemError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddChecklistItemError> =
...
pub async fn change_owner(
    configuration: &configuration::Configuration,
    id: &str,
    change_owner_request: Option<models::ChangeOwnerRequest>,
) -> Result<(), Error<ChangeOwnerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ChangeOwnerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_playbook_run_from_post(
    configuration: &configuration::Configuration,
    create_playbook_run_from_post_request: Option<models::CreatePlaybookRunFromPostRequest>,
) -> Result<models::PlaybookRun, Error<CreatePlaybookRunFromPostError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreatePlaybookRunFromPostError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn end_playbook_run(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<(), Error<EndPlaybookRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EndPlaybookRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels(
...
) -> Result<Vec<String>, Error<GetChannelsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = owner_user_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("owner_user_id", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = participant_id {
        local_var_req_builder =
            local_var_req_builder.query(&[("participant_id", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn get_owners(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<Vec<models::OwnerInfo>, Error<GetOwnersError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetOwnersError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_playbook_run(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::PlaybookRun, Error<GetPlaybookRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlaybookRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_playbook_run_by_channel_id(
    configuration: &configuration::Configuration,
    channel_id: &str,
) -> Result<models::PlaybookRun, Error<GetPlaybookRunByChannelIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlaybookRunByChannelIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_playbook_run_metadata(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<models::PlaybookRunMetadata, Error<GetPlaybookRunMetadataError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetPlaybookRunMetadataError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn item_delete(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ItemDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn item_rename(
    configuration: &configuration::Configuration,
    id: &str,
    checklist: i32,
    item: i32,
    item_rename_request: Option<models::ItemRenameRequest>,
) -> Result<(), Error<ItemRenameError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ItemRenameError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn item_run(
    configuration: &configuration::Configuration,
    id: &str,
    checklist: i32,
    item: i32,
) -> Result<models::TriggerIdReturn, Error<ItemRunError>> {
    let local_var_configuration = configuration;
...
pub async fn item_set_assignee(
    configuration: &configuration::Configuration,
    id: &str,
    checklist: i32,
    item: i32,
    item_set_assignee_request: Option<models::ItemSetAssigneeRequest>,
) -> Result<(), Error<ItemSetAssigneeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ItemSetAssigneeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn item_set_state(
    configuration: &configuration::Configuration,
    id: &str,
    checklist: i32,
    item: i32,
    item_set_state_request: Option<models::ItemSetStateRequest>,
) -> Result<(), Error<ItemSetStateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ItemSetStateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_playbook_runs(
    ...
    participant_id: Option<&str>,
    search_term: Option<&str>,
) -> Result<models::PlaybookRunList, Error<ListPlaybookRunsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListPlaybookRunsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn reoder_checklist_item(
    configuration: &configuration::Configuration,
    id: &str,
    checklist: i32,
    reoder_checklist_item_request: Option<models::ReoderChecklistItemRequest>,
) -> Result<(), Error<ReoderChecklistItemError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ReoderChecklistItemError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn restart_playbook_run(
    configuration: &configuration::Configuration,
    id: &str,
) -> Result<(), Error<RestartPlaybookRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RestartPlaybookRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn status(
    configuration: &configuration::Configuration,
    id: &str,
    status_request: Option<models::StatusRequest>,
...
pub async fn update_playbook_run(
    configuration: &configuration::Configuration,
    id: &str,
    update_playbook_run_request: Option<models::UpdatePlaybookRunRequest>,
) -> Result<(), Error<UpdatePlaybookRunError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdatePlaybookRunError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
