...
pub async fn confirm_customer_payment(
    configuration: &configuration::Configuration,
    stripe_setup_intent_id: Option<&str>,
) -> Result<(), Error<ConfirmCustomerPaymentError>> {
    ...
    if let Some(local_var_param_value) = stripe_setup_intent_id {
        local_var_form =
            local_var_form.text("stripe_setup_intent_id", local_var_param_value.to_string());
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConfirmCustomerPaymentError> =
...
pub async fn create_customer_payment(
    configuration: &configuration::Configuration,
) -> Result<models::PaymentSetupIntent, Error<CreateCustomerPaymentError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateCustomerPaymentError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_cloud_customer(
    configuration: &configuration::Configuration,
) -> Result<models::CloudCustomer, Error<GetCloudCustomerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCloudCustomerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_cloud_limits(
    configuration: &configuration::Configuration,
) -> Result<models::ProductLimits, Error<GetCloudLimitsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCloudLimitsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_cloud_products(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Product>, Error<GetCloudProductsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCloudProductsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_endpoint_for_installation_information(
    configuration: &configuration::Configuration,
) -> Result<models::Installation, Error<GetEndpointForInstallationInformationError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetEndpointForInstallationInformationError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_invoice_for_subscription_as_pdf(
    configuration: &configuration::Configuration,
    invoice_id: &str,
) -> Result<(), Error<GetInvoiceForSubscriptionAsPdfError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetInvoiceForSubscriptionAsPdfError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_invoices_for_subscription(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Invoice>, Error<GetInvoicesForSubscriptionError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetInvoicesForSubscriptionError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_subscription(
    configuration: &configuration::Configuration,
) -> Result<models::Subscription, Error<GetSubscriptionError>> {
    let local_var_configuration = configuration;
...
pub async fn post_endpoint_for_cws_webhooks(
    configuration: &configuration::Configuration,
) -> Result<(), Error<PostEndpointForCwsWebhooksError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostEndpointForCwsWebhooksError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_cloud_customer(
    configuration: &configuration::Configuration,
    update_cloud_customer_request: models::UpdateCloudCustomerRequest,
) -> Result<models::CloudCustomer, Error<UpdateCloudCustomerError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateCloudCustomerError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_cloud_customer_address(
    configuration: &configuration::Configuration,
    address: models::Address,
) -> Result<models::CloudCustomer, Error<UpdateCloudCustomerAddressError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateCloudCustomerAddressError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
