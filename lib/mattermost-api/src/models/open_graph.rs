...
pub struct OpenGraph {
    ...
    pub images: Option<Vec<models::OpenGraphImagesInner>>,
    #[serde(rename = "videos", skip_serializing_if = "Option::is_none")]
    pub videos: Option<Vec<models::OpenGraphVideosInner>>,
    #[serde(rename = "audios", skip_serializing_if = "Option::is_none")]
    pub audios: Option<Vec<models::OpenGraphAudiosInner>>,
    #[serde(rename = "article", skip_serializing_if = "Option::is_none")]
    pub article: Option<Box<models::OpenGraphArticle>>,
    #[serde(rename = "book", skip_serializing_if = "Option::is_none")]
    pub book: Option<Box<models::OpenGraphBook>>,
    #[serde(rename = "profile", skip_serializing_if = "Option::is_none")]
    pub profile: Option<Box<models::OpenGraphArticleAuthorsInner>>,
}
