...
pub struct SearchUsersRequest {
    ...
    #[serde(rename = "allow_inactive", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "without_team", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
