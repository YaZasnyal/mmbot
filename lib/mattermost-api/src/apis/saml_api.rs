...
/// struct for typed errors of method [`migrate_auth_to_saml_2`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum MigrateAuthToSaml2Error {
...
pub async fn delete_saml_idp_certificate(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<DeleteSamlIdpCertificateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/certificate/idp", local_var_configuration.base_path);
...
pub async fn delete_saml_private_certificate(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<DeleteSamlPrivateCertificateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/certificate/private", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn delete_saml_public_certificate(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<DeleteSamlPublicCertificateError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/certificate/public", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn get_saml_certificate_status(configuration: &configuration::Configuration, ) -> Result<models::SamlCertificateStatus, Error<GetSamlCertificateStatusError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/certificate/status", local_var_configuration.base_path);
...
pub async fn get_saml_metadata(configuration: &configuration::Configuration, ) -> Result<String, Error<GetSamlMetadataError>> {
    ...
    let local_var_uri_str = format!("{}/api/v4/saml/metadata", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_saml_metadata_from_idp(configuration: &configuration::Configuration, get_saml_metadata_from_idp_request: Option<models::GetSamlMetadataFromIdpRequest>) -> Result<String, Error<GetSamlMetadataFromIdpError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/metadatafromidp", local_var_configuration.base_path);
...
pub async fn migrate_auth_to_saml_2(configuration: &configuration::Configuration, migrate_auth_to_saml_request: Option<models::MigrateAuthToSamlRequest>) -> Result<(), Error<MigrateAuthToSaml2Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToSaml2Error> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn reset_saml_auth_data_to_email(configuration: &configuration::Configuration, reset_saml_auth_data_to_email_request: Option<models::ResetSamlAuthDataToEmailRequest>) -> Result<models::ResetSamlAuthDataToEmail200Response, Error<ResetSamlAuthDataToEmailError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/saml/reset_auth_data", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn upload_saml_idp_certificate(configuration: &configuration::Configuration, certificate: std::path::PathBuf) -> Result<models::StatusOk, Error<UploadSamlIdpCertificateError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_saml_private_certificate(configuration: &configuration::Configuration, certificate: std::path::PathBuf) -> Result<models::StatusOk, Error<UploadSamlPrivateCertificateError>> {
    let local_var_configuration = configuration;
...
pub async fn upload_saml_public_certificate(configuration: &configuration::Configuration, certificate: std::path::PathBuf) -> Result<models::StatusOk, Error<UploadSamlPublicCertificateError>> {
    let local_var_configuration = configuration;
