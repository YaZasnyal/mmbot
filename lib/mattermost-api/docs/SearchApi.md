...
------------- | ------------- | -------------
[**search_files_1**](SearchApi.md#search_files_1) | **POST** /api/v4/teams/{team_id}/files/search | Search files in a team



## search_files_1

> models::FileInfoList search_files_1(team_id, terms, is_or_search, time_zone_offset, include_deleted_channels, page, per_page)
