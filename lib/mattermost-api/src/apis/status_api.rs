...
pub async fn get_user_status(
    ...
    user_id: &str,
) -> Result<models::Status, Error<GetUserStatusError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUserStatusError> =
...
pub async fn get_users_statuses_by_ids(
    configuration: &configuration::Configuration,
    request_body: Vec<String>,
) -> Result<Vec<models::Status>, Error<GetUsersStatusesByIdsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetUsersStatusesByIdsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn post_user_recent_custom_status_delete(
    configuration: &configuration::Configuration,
    user_id: &str,
    remove_recent_custom_status_request: models::RemoveRecentCustomStatusRequest,
) -> Result<(), Error<PostUserRecentCustomStatusDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PostUserRecentCustomStatusDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_recent_custom_status(
    ...
    user_id: &str,
    remove_recent_custom_status_request: models::RemoveRecentCustomStatusRequest,
) -> Result<(), Error<RemoveRecentCustomStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveRecentCustomStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn unset_user_custom_status(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<(), Error<UnsetUserCustomStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UnsetUserCustomStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_custom_status(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_custom_status_request: models::UpdateUserCustomStatusRequest,
) -> Result<(), Error<UpdateUserCustomStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserCustomStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_user_status(
    configuration: &configuration::Configuration,
    user_id: &str,
    update_user_status_request: models::UpdateUserStatusRequest,
) -> Result<models::Status, Error<UpdateUserStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateUserStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
