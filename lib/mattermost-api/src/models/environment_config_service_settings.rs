...
pub struct EnvironmentConfigServiceSettings {
    #[serde(rename = "SiteURL", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub site_url: Option<bool>,
    #[serde(rename = "ListenAddress", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "TLSCertFile", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub tls_cert_file: Option<bool>,
    #[serde(rename = "TLSKeyFile", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "LetsEncryptCertificateCacheFile", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "ReadTimeout", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub read_timeout: Option<bool>,
    #[serde(rename = "WriteTimeout", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub write_timeout: Option<bool>,
    #[serde(rename = "MaximumLoginAttempts", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub maximum_login_attempts: Option<bool>,
    #[serde(rename = "SegmentDeveloperKey", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub segment_developer_key: Option<bool>,
    #[serde(rename = "GoogleDeveloperKey", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "AllowCorsFrom", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub allow_cors_from: Option<bool>,
    #[serde(rename = "SessionLengthWebInDays", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub session_length_web_in_days: Option<bool>,
    #[serde(rename = "SessionLengthMobileInDays", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub session_length_mobile_in_days: Option<bool>,
    #[serde(rename = "SessionLengthSSOInDays", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub session_length_ssoin_days: Option<bool>,
    #[serde(rename = "SessionCacheInMinutes", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub session_cache_in_minutes: Option<bool>,
    #[serde(rename = "WebsocketSecurePort", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub websocket_secure_port: Option<bool>,
    #[serde(rename = "WebsocketPort", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    pub websocket_port: Option<bool>,
    #[serde(rename = "WebserverMode", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
    ...
    #[serde(rename = "RestrictCustomEmojiCreation", skip_serializing_if = "Option::is_none", default, deserialize_with = "bool_parser::deserialize_option_bool")]
