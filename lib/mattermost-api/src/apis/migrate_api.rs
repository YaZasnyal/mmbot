...
pub async fn migrate_auth_to_ldap_0(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToLdap0Error> =
...
pub async fn migrate_auth_to_saml_0(
    configuration: &configuration::Configuration,
    migrate_auth_to_saml_request: Option<models::MigrateAuthToSamlRequest>,
) -> Result<(), Error<MigrateAuthToSaml0Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MigrateAuthToSaml0Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
