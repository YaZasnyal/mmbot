...
pub async fn create_command(
    ...
    create_command_request: models::CreateCommandRequest,
) -> Result<models::Command, Error<CreateCommandError>> {
...
pub async fn delete_command(
    configuration: &configuration::Configuration,
    command_id: &str,
) -> Result<models::StatusOk, Error<DeleteCommandError>> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        command_id = crate::apis::urlencode(command_id)
    );
    let mut local_var_req_builder =
...
pub async fn execute_command(
...
) -> Result<models::CommandResponse, Error<ExecuteCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ExecuteCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_command_by_id(
    configuration: &configuration::Configuration,
    command_id: &str,
) -> Result<models::Command, Error<GetCommandByIdError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetCommandByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_autocomplete_commands(
    configuration: &configuration::Configuration,
    team_id: &str,
) -> Result<Vec<models::Command>, Error<ListAutocompleteCommandsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListAutocompleteCommandsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_command_autocomplete_suggestions(
    ...
    team_id: &str,
    user_input: &str,
) -> Result<Vec<models::AutocompleteSuggestion>, Error<ListCommandAutocompleteSuggestionsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListCommandAutocompleteSuggestionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn list_commands(
...
) -> Result<Vec<models::Command>, Error<ListCommandsError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = custom_only {
        local_var_req_builder =
            local_var_req_builder.query(&[("custom_only", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListCommandsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn move_command(
    configuration: &configuration::Configuration,
    command_id: &str,
    move_command_request: models::MoveCommandRequest,
) -> Result<models::StatusOk, Error<MoveCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<MoveCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn regen_command_token(
    configuration: &configuration::Configuration,
    command_id: &str,
) -> Result<models::RegenCommandToken200Response, Error<RegenCommandTokenError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RegenCommandTokenError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_command(
...
) -> Result<models::Command, Error<UpdateCommandError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateCommandError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
