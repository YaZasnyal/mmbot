...
pub async fn add_channels_to_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    request_body: Vec<String>,
) -> Result<models::StatusOk, Error<AddChannelsToRetentionPolicyError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddChannelsToRetentionPolicyError> =
...
pub async fn add_teams_to_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    request_body: Vec<String>,
) -> Result<models::StatusOk, Error<AddTeamsToRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AddTeamsToRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_data_retention_policy(
    configuration: &configuration::Configuration,
    data_retention_policy_create: models::DataRetentionPolicyCreate,
) -> Result<
    models::DataRetentionPolicyWithTeamAndChannelCounts,
    Error<CreateDataRetentionPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateDataRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn delete_data_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
) -> Result<models::StatusOk, Error<DeleteDataRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteDataRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channel_policies_for_user(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::RetentionPolicyForChannelList, Error<GetChannelPoliciesForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelPoliciesForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_channels_for_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::ChannelWithTeamData>, Error<GetChannelsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetChannelsForRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_retention_policies(
    configuration: &configuration::Configuration,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<
    Vec<models::DataRetentionPolicyWithTeamAndChannelCounts>,
    Error<GetDataRetentionPoliciesError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataRetentionPoliciesError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_retention_policies_count(
    configuration: &configuration::Configuration,
) -> Result<
    models::GetDataRetentionPoliciesCount200Response,
    Error<GetDataRetentionPoliciesCountError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataRetentionPoliciesCountError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_retention_policy(
    configuration: &configuration::Configuration,
) -> Result<models::GlobalDataRetentionPolicy, Error<GetDataRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_data_retention_policy_by_id(
    configuration: &configuration::Configuration,
    policy_id: &str,
) -> Result<
    models::DataRetentionPolicyWithTeamAndChannelCounts,
    Error<GetDataRetentionPolicyByIdError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetDataRetentionPolicyByIdError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_team_policies_for_user(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::RetentionPolicyForTeamList, Error<GetTeamPoliciesForUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamPoliciesForUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_teams_for_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Team>, Error<GetTeamsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetTeamsForRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn patch_data_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    data_retention_policy_with_team_and_channel_ids: models::DataRetentionPolicyWithTeamAndChannelIds,
) -> Result<models::DataRetentionPolicyWithTeamAndChannelCounts, Error<PatchDataRetentionPolicyError>>
{
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&data_retention_policy_with_team_and_channel_ids);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PatchDataRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_channels_from_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    request_body: Vec<String>,
) -> Result<models::StatusOk, Error<RemoveChannelsFromRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveChannelsFromRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn remove_teams_from_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    request_body: Vec<String>,
) -> Result<models::StatusOk, Error<RemoveTeamsFromRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<RemoveTeamsFromRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_channels_for_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    search_channels_for_retention_policy_request: models::SearchChannelsForRetentionPolicyRequest,
) -> Result<Vec<models::ChannelWithTeamData>, Error<SearchChannelsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder =
        local_var_req_builder.json(&search_channels_for_retention_policy_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchChannelsForRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_teams_for_retention_policy(
    configuration: &configuration::Configuration,
    policy_id: &str,
    search_teams_for_retention_policy_request: models::SearchTeamsForRetentionPolicyRequest,
) -> Result<Vec<models::Team>, Error<SearchTeamsForRetentionPolicyError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchTeamsForRetentionPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
