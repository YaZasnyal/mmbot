...
pub async fn cancel_job(
    ...
    job_id: &str,
) -> Result<models::StatusOk, Error<CancelJobError>> {
...
pub async fn create_job(
    configuration: &configuration::Configuration,
    create_job_request: models::CreateJobRequest,
) -> Result<models::Job, Error<CreateJobError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateJobError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn download_job(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DownloadJobError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_job(
    configuration: &configuration::Configuration,
    job_id: &str,
) -> Result<models::Job, Error<GetJobError>> {
    let local_var_configuration = configuration;
...
pub async fn get_jobs_by_type(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<Vec<models::Job>, Error<GetJobsByTypeError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetJobsByTypeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn update_job_status(
    configuration: &configuration::Configuration,
    job_id: &str,
    update_job_status_request: models::UpdateJobStatusRequest,
) -> Result<models::StatusOk, Error<UpdateJobStatusError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<UpdateJobStatusError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
