...
pub async fn create_o_auth_app(configuration: &configuration::Configuration, create_o_auth_app_request: models::CreateOAuthAppRequest) -> Result<models::OAuthApp, Error<CreateOAuthAppError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/oauth/apps", local_var_configuration.base_path);
...
pub async fn delete_o_auth_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::StatusOk, Error<DeleteOAuthAppError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/oauth/apps/{app_id}", local_var_configuration.base_path, app_id=crate::apis::urlencode(app_id));
...
pub async fn get_authorized_o_auth_apps_for_user(configuration: &configuration::Configuration, user_id: &str, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::OAuthApp>, Error<GetAuthorizedOAuthAppsForUserError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/oauth/apps/authorized", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id));
...
pub async fn get_o_auth_app(configuration: &configuration::Configuration, app_id: &str) -> Result<models::OAuthApp, Error<GetOAuthAppError>> {
    let local_var_configuration = configuration;
...
pub async fn get_o_auth_app_info(configuration: &configuration::Configuration, app_id: &str) -> Result<models::OAuthApp, Error<GetOAuthAppInfoError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/oauth/apps/{app_id}/info", local_var_configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
...
pub async fn get_o_auth_apps(configuration: &configuration::Configuration, page: Option<i32>, per_page: Option<i32>) -> Result<Vec<models::OAuthApp>, Error<GetOAuthAppsError>> {
    let local_var_configuration = configuration;
...
pub async fn regenerate_o_auth_app_secret(configuration: &configuration::Configuration, app_id: &str) -> Result<models::OAuthApp, Error<RegenerateOAuthAppSecretError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/oauth/apps/{app_id}/regen_secret", local_var_configuration.base_path, app_id=crate::apis::urlencode(app_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
...
pub async fn update_o_auth_app(configuration: &configuration::Configuration, app_id: &str, update_o_auth_app_request: models::UpdateOAuthAppRequest) -> Result<models::OAuthApp, Error<UpdateOAuthAppError>> {
    let local_var_configuration = configuration;
