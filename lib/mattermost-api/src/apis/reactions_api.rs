...
pub async fn delete_reaction(configuration: &configuration::Configuration, user_id: &str, post_id: &str, emoji_name: &str) -> Result<models::StatusOk, Error<DeleteReactionError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/users/{user_id}/posts/{post_id}/reactions/{emoji_name}", local_var_configuration.base_path, user_id=crate::apis::urlencode(user_id), post_id=crate::apis::urlencode(post_id), emoji_name=crate::apis::urlencode(emoji_name));
...
pub async fn get_bulk_reactions(configuration: &configuration::Configuration, request_body: Vec<String>) -> Result<std::collections::HashMap<String, Vec<models::Reaction>>, Error<GetBulkReactionsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/posts/ids/reactions", local_var_configuration.base_path);
...
pub async fn get_reactions(configuration: &configuration::Configuration, post_id: &str) -> Result<Vec<models::Reaction>, Error<GetReactionsError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/posts/{post_id}/reactions", local_var_configuration.base_path, post_id=crate::apis::urlencode(post_id));
...
pub async fn save_reaction(configuration: &configuration::Configuration, reaction: models::Reaction) -> Result<models::Reaction, Error<SaveReactionError>> {
    let local_var_configuration = configuration;
