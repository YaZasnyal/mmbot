...
pub async fn assign_bot(
    ...
    bot_user_id: &str,
    user_id: &str,
) -> Result<models::Bot, Error<AssignBotError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<AssignBotError> =
...
pub async fn convert_bot_to_user(
...
) -> Result<models::StatusOk, Error<ConvertBotToUserError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConvertBotToUserError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn convert_user_to_bot(
    configuration: &configuration::Configuration,
    user_id: &str,
) -> Result<models::StatusOk, Error<ConvertUserToBotError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ConvertUserToBotError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn create_bot(
    configuration: &configuration::Configuration,
    create_bot_request: models::CreateBotRequest,
) -> Result<models::Bot, Error<CreateBotError>> {
    let local_var_configuration = configuration;
...
pub async fn delete_bot_icon_image(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
) -> Result<models::StatusOk, Error<DeleteBotIconImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DeleteBotIconImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn disable_bot(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
) -> Result<models::Bot, Error<DisableBotError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DisableBotError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn enable_bot(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
) -> Result<models::Bot, Error<EnableBotError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<EnableBotError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
) -> Result<models::Bot, Error<GetBotError>> {
    let local_var_configuration = configuration;
...
pub async fn get_bot_icon_image(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
) -> Result<(), Error<GetBotIconImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetBotIconImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_bots(
    ...
    if let Some(ref local_var_str) = only_orphaned {
        local_var_req_builder =
            local_var_req_builder.query(&[("only_orphaned", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn patch_bot(
    ...
    bot_user_id: &str,
    create_bot_request: models::CreateBotRequest,
) -> Result<models::Bot, Error<PatchBotError>> {
    let local_var_configuration = configuration;
...
pub async fn set_bot_icon_image(
    configuration: &configuration::Configuration,
    bot_user_id: &str,
    image: std::path::PathBuf,
) -> Result<models::StatusOk, Error<SetBotIconImageError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SetBotIconImageError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
