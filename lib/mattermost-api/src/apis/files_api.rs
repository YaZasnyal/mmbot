...
pub async fn get_file_info(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFileInfoError> =
...
pub async fn get_file_link(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<models::GetFileLink200Response, Error<GetFileLinkError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFileLinkError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_file_preview(
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFilePreviewError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_file_public(
    configuration: &configuration::Configuration,
    file_id: &str,
    h: &str,
) -> Result<(), Error<GetFilePublicError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFilePublicError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn get_file_thumbnail(
    configuration: &configuration::Configuration,
    file_id: &str,
) -> Result<(), Error<GetFileThumbnailError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<GetFileThumbnailError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn search_files_0(
    ...
    page: Option<i32>,
    per_page: Option<i32>,
) -> Result<models::FileInfoList, Error<SearchFiles0Error>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<SearchFiles0Error> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn upload_file(
    ...
    channel_id2: Option<&str>,
    client_ids: Option<&str>,
) -> Result<models::UploadFile201Response, Error<UploadFileError>> {
    let local_var_configuration = configuration;
