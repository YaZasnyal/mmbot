...
pub async fn purge_bleve_indexes(configuration: &configuration::Configuration, ) -> Result<models::StatusOk, Error<PurgeBleveIndexesError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/v4/bleve/purge_indexes", local_var_configuration.base_path);
